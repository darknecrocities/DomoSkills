...
export default function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* 1. HERO SECTION */}
      {/* ========================================================================= */}
      <section className="relative border-b border-border pt-12 pb-16 sm:pt-20 sm:pb-24 tech-grid-bg">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
            
            {/* Left Hero Column */}
            <ScrollReveal direction="up" distance={20} duration={0.6} className="lg:col-span-7 space-y-6 sm:space-y-7">
              
              {/* Top Branding Pill with Fluid Motion Transition */}
              <AnimatedPillBadge />

              {/* Main Editorial Headline with Fluid Word Slide */}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pt-2 font-mono text-xs">
                <div className="flex flex-wrap items-center gap-3">
                  <Link
                    href="/explore"
                    className="flex-1 sm:flex-initial flex items-center justify-center gap-2 rounded-xl border border-white bg-white px-5 py-2.5 font-bold uppercase tracking-wider text-black hover:bg-muted-white transition shadow-[0_0_20px_rgba(255,255,255,0.15)]"
                  >
                  ...
                  <Link
                    href="/submit"
                    className="flex-1 sm:flex-initial flex items-center justify-center gap-2 rounded-xl border border-border bg-surface px-5 py-2.5 font-semibold text-text-secondary hover:border-white hover:text-white transition"
                  >
                ...
                <div className="flex flex-wrap items-center gap-4 text-text-muted pt-2 sm:pt-0 sm:pl-4 sm:border-l border-border font-mono text-xs">
                  ...
                  <div title="Total registered developers in community">
                    <span suppressHydrationWarning className="text-white font-bold">{formattedUsers}</span> Developers
                  </div>
            ...
            <ScrollReveal direction="left" distance={24} delay={0.15} duration={0.6} className="lg:col-span-5">
      ...
      {/* 3. EXPLORE BY DOMAIN */}
      {/* ========================================================================= */}
      <section className="border-b border-border py-16 sm:py-20 bg-transparent">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          
          <ScrollReveal direction="up" distance={16} className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-12 gap-4">
            <div>
          ...
          <ScrollReveal direction="up" distance={20} delay={0.1} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {categories.map((cat, idx) => (
              <Link
                key={cat.slug}
                href={`/explore?category=${cat.slug}`}
                className="group card-polkadot-hover relative rounded-xl border border-border bg-surface p-5 transition-all duration-300 hover:border-white hover:bg-surface-raised hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(0,0,0,0.7)]"
              >
      ...
      {/* ========================================================================= */}
      {/* 4. TRENDING SKILLS (Home Page Grid - Tab Removed per user request) */}
      {/* ========================================================================= */}
      <section className="border-b border-border py-16 sm:py-20 bg-transparent tech-grid-bg">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal direction="up" distance={20} delay={0.1} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="border-b border-border py-16 sm:py-20 bg-transparent">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal direction="up" distance={16} className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-2">
            <div className="font-mono text-xs font-bold uppercase tracking-widest text-text-muted">
              Workflow
            </div>
          ...
          <ScrollReveal direction="up" distance={20} delay={0.1} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="border-b border-border py-16 sm:py-20 bg-transparent">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal direction="up" distance={16} className="max-w-2xl mb-10 sm:mb-12 space-y-2">
            <div className="font-mono text-xs font-bold uppercase tracking-widest text-text-muted">
          ...
          <ScrollReveal direction="up" distance={20} delay={0.1} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 font-mono text-xs">
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-[10px] text-emerald-400 border border-emerald-900/60 bg-emerald-950/30 px-1.5 py-0.2 rounded font-mono">
                        Native
                      </span>
                    </div>
      ...
      {/* ========================================================================= */}
      <section className="py-20 sm:py-24 bg-transparent tech-grid-bg border-t border-border">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          
          <ScrollReveal direction="up" distance={20} className="card-polkadot-hover rounded-2xl border border-border bg-surface p-6 sm:p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10">
            
            <div className="space-y-4 max-w-xl">
              <div className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface-raised px-3 py-1 font-mono text-xs text-text-secondary">
                <Lock className="h-3.5 w-3.5 text-white" />
                <span>Open Source Manifesto</span>
              </div>

              <h2 className="font-sans text-2xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3 font-mono text-xs">
                <Link
                  href="/explore"
                  className="rounded-xl border border-white bg-white px-5 py-2.5 font-bold uppercase tracking-wider text-black hover:bg-muted-white transition shadow-[0_0_15px_rgba(255,255,255,0.15)]"
                >
                  Explore Registry
                </Link>
                <Link
                  href="/submit"
                  className="rounded-xl border border-border bg-surface-raised px-5 py-2.5 font-semibold text-white hover:border-white transition"
                >
                  Publish a Skill
                </Link>
                <a
              ...
              {/* Live Registry Sync Footnote - Clean metadata */}
